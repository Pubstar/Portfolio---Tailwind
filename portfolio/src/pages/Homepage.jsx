        ...
        <div>
            ...
            <section className='pb-32'>
                ...
                <div className="flex gap-12 flex-wrap items-center justify-center bg-white/10 p-4 md:p-10 rounded-3xl">
                    ...
                    <ProjectCard bg={chatboxImg} name="Chatbox" description="A simple chatbox made using Firebase and React, you can log-in with your Google account to chat or view the chat as a guest." githubLink="https://github.com/Pubstar/FirebaseChat/tree/main/firebasechat" livePageLink="https://chatbox-fb.web.app/" />
