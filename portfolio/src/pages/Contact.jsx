        ...
        <div className=' min-h-screen'>
            <main className=' text-center'>
                <form netlify name='contact' id='contactForm' className='flex flex-col justify-center items-center mb-4 bg-white/10 p-4 rounded-3xl'>
                    ...
                    <input className=' mb-4 w-96 text-black rounded-xl p-1' type="text" name="name" id="name" />
                    <label htmlFor="email">Your email:</label>
                    <input className=' mb-4 w-96 text-black rounded-xl p-1' type="email" name="email" id="email" />
                    <label htmlFor="message">Please leave a message:</label>
                    <textarea className=' mb-4 text-black rounded-xl p-1' name="message" id="message" cols="46" rows="10"></textarea>
