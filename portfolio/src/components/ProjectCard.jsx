...
const ProjectCard = (props) => {
    return (
        <div id='card' className=" w-64 h-96 relative rounded-3xl overflow-hidden shadow-xl shadow-black/40 p-4 text-center">
            <span className="font-bold text-3xl z-20 relative">{props.name}</span>
            <p id='text' className=" z-20 relative mt-10">{props.description}</p>
